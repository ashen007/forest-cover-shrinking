...
from forest_cover_change_detection.models.experiments.focus_att import FocusAttentionGateV2


class FCFEResNeStFocAt(nn.Module):

    def __init__(self, in_channels, classes, kernel=3):
        super(FCFEResNeStFocAt, self).__init__()
    ...
    def forward(self, x_1, x_2):
        ...
        at_gate_1 = FocusAttentionGateV2(xu_1_b.shape[1], xd_4_b1.shape[1])
        ...
        at_gate_2 = FocusAttentionGateV2(xu_2_b.shape[1], xd_3_b1.shape[1])

        # concat skip connection and up-sampled layer from below
        xu_2 = torch.cat((at_gate_2((xd_3_b1 - xd_3_b2), xu_2_b), pad_2(xu_2)), dim=1)
        ...
        at_gate_3 = FocusAttentionGateV2(xu_3_b.shape[1], xd_2_b1.shape[1])
        ...
        at_gate_4 = FocusAttentionGateV2(xu_4_b.shape[1], xd_1_b1.shape[1])

        # concat skip connection and up-sampled layer from below
        xu_4 = torch.cat((at_gate_4((xd_1_b1 - xd_1_b2), xu_4_b), pad_4(xu_4)), dim=1)

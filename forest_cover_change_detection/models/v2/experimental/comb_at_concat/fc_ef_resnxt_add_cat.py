...
class FCFEResNeXtAddV1(nn.Module):

    def __init__(self, in_channels, classes, kernel=3):
        super(FCFEResNeXtAddV1, self).__init__()
    ...
    def forward(self, x_1, x_2):
        ...
        attened_1 = at_gate_1(xd_4_b1, xu_1_b) - at_gate_1(xd_4_b2, xu_1_b)
        xu_1 = torch.cat((attened_1, pad_1(xu_1)), dim=1)
        ...
        # concat skip connection and up-sampled layer from below
        attened_2 = at_gate_2(xd_3_b1, xu_2_b) - at_gate_2(xd_3_b2, xu_2_b)
        xu_2 = torch.cat((attened_2, pad_2(xu_2)), dim=1)
        ...
        # concat skip connection and up-sampled layer from below
        attened_3 = at_gate_3(xd_2_b1, xu_3_b) - at_gate_3(xd_2_b2, xu_3_b)
        xu_3 = torch.cat((attened_3, pad_3(xu_3)), dim=1)
        ...
        # concat skip connection and up-sampled layer from below
        attened_4 = at_gate_4(xd_1_b1, xu_4_b) - at_gate_4(xd_1_b2, xu_4_b)
        xu_4 = torch.cat((attened_4, pad_4(xu_4)), dim=1)

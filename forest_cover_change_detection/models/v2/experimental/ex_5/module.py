...
from forest_cover_change_detection.models.v2.experimental.new_gates.modules import DualAttentionV6
...
class FCFEResSplitAttention(nn.Module):
    ...
    def forward(self, x_1, x_2):
        ...
        gate_1 = DualAttentionV6(xu_1_b.shape[1], s_4[1])
        ...
        gate_2 = DualAttentionV6(xu_2_b.shape[1], s_3[1])
        ...
        gate_3 = DualAttentionV6(xu_3_b.shape[1], s_2[1])
        ...
        gate_4 = DualAttentionV6(xu_4_b.shape[1], s_1[1])

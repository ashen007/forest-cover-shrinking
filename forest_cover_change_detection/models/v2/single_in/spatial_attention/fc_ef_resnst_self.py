...
from forest_cover_change_detection.models.fcfe_with_att.modules import SelfAttention


class FCFEResSplitAttentionSelf(nn.Module):

    def __init__(self, in_channels, classes, kernel=3):
        super(FCFEResSplitAttentionSelf, self).__init__()
    ...
    def forward(self, x):
        ...
        # self attention
        self_at_8 = SelfAttention(s_5[1], 256, 1)(xd_5)
        self_at_16 = SelfAttention(s_5[1], 128, 2)(xd_5)
        self_at_32 = SelfAttention(s_5[1], 64, 4)(xd_5)
        self_at_64 = SelfAttention(s_5[1], 32, 8)(xd_5)
        self_at_128 = SelfAttention(s_5[1], 16, 16)(xd_5)

        xd_1 = xd_1 * self_at_128
        xd_2 = xd_2 * self_at_64
        xd_3 = xd_3 * self_at_32
        xd_4 = xd_4 * self_at_16
        xd_5 = xd_5 * self_at_8
...
if __name__ == '__main__':
    ...
    model = FCFEResSplitAttentionSelf(6, 2)
    model.cuda()

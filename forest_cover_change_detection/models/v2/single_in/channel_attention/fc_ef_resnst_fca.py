...
from forest_cover_change_detection.models.fcef.modules import ResidualDownSample, UpSample, ResNeStFCA


class FCFEResSplitAttentionFCA(nn.Module):

    def __init__(self, in_channels, classes, kernel=3):
        super(FCFEResSplitAttentionFCA, self).__init__()
...
if __name__ == '__main__':
    ...
    model = FCFEResSplitAttentionFCA(6, 2)
    model.cuda()

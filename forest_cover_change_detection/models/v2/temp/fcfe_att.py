...
class FCEFVanilaWithAAT(nn.Module):
    """
    ...
    def __init__(self, in_channels, classes, kernel=3):
        super(FCEFVanilaWithAAT, self).__init__()
    ...
    def forward(self, x):  # (16, 6, 96, 96)
        ...
        at_gate_1 = AdditiveAttentionGate(xd_5.shape[1], xd_4.shape[1])

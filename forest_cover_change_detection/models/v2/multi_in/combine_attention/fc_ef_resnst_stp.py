...
class FCFEResSplitAttentionSTP(nn.Module):

    def __init__(self, in_channels, classes, kernel=3):
        super(FCFEResSplitAttentionSTP, self).__init__()
    ...
    def forward(self, x_1, x_2):
        ...
        sp_1 = StripPooling(xd_4_b1.shape[1], (8, 8))

        # concat skip connection and up-sampled layer from below
        xu_1 = torch.cat((sp_1(xd_4_b1 - xd_4_b2), pad_1(xu_1)), dim=1)
        ...
        sp_2 = StripPooling(xd_3_b1.shape[1], (16, 16))

        # concat skip connection and up-sampled layer from below
        xu_2 = torch.cat((sp_2(xd_3_b1 - xd_3_b2), pad_2(xu_2)), dim=1)
        ...
        sp_3 = StripPooling(xd_2_b1.shape[1], (32, 32))

        # concat skip connection and up-sampled layer from below
        xu_3 = torch.cat((sp_3(xd_2_b1 - xd_2_b2), pad_3(xu_3)), dim=1)
        ...
        sp_4 = StripPooling(xd_1_b1.shape[1], (64, 64))

        # concat skip connection and up-sampled layer from below
        xu_4 = torch.cat((sp_4(xd_1_b1 - xd_1_b2), pad_4(xu_4)), dim=1)
...
if __name__ == '__main__':
    ...
    model = FCFEResSplitAttentionSTP(3, 2)
    model.cuda()

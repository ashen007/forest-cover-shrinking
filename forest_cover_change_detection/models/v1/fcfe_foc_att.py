...
class FCFEWithFocusAttention(nn.Module):

    def __init__(self, in_channels, classes, kernel=3):
        super(FCFEWithFocusAttention, self).__init__()
    ...
    def forward(self, x):
        ...
        foc_gate_1 = FocusAttentionGate(128, x_3.shape[1], 2, 1, 1)
        x_3_attended = foc_gate_1(x_3, x_4)
        ...
        foc_gate_2 = FocusAttentionGate(128, x_2.shape[1], 4, 1, 3)
        x_2_attended = foc_gate_2(x_2, x_4)
        ...
        foc_gate_3 = FocusAttentionGate(128, x_1.shape[1], 8, 1, 7)
        x_1_attended = foc_gate_3(x_1, x_4)
...
if __name__ == "__main__":
    ...
    model = FCFEWithFocusAttention(6, 2)
    out = model(t)
